...
namespace canvasaufgabe4 {
    ...
    function drawFahrer(_driver: SkifahrerBewegen): void {
        crc2.beginPath();
    ...
    function animate(): void {
        ...
        //Skifahrer
        for (let i: number = 0; i < SBewegen.length; i++) {
    ...
    function BewegedichSkifahrer(_SBewegen: SkifahrerBewegen): void {
